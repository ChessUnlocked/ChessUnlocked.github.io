        /***** 🔧 CONFIG — REPLACE THESE VALUES (Firebase + Gemini) *****/
        const CONFIG = {
        ...
        // --- Sanity checks so “Signup Error” is actually actionable
        ...
        const pieces = {'r':'♜','n':'♞','b':'♝','q':'♛','k':'♚','p':'♟︎','R':'♖','N':'♘','B':'♗','Q':'♕','K':'♔','P':'♙'};
        ...
        const openingSelector = document.getElementById('openingSelector');
        ...
        function applyTheme(isDark) {
            if (isDark) { html.classList.add('dark'); darkModeToggler.textContent = '☀️'; }
            else { html.classList.remove('dark'); darkModeToggler.textContent = '🌙'; }
        }
        (function initTheme() {
            try {
        ...
        // --- Chessboard rendering and animation (Multiple opening sequences) ---
        const openingSequences = {
            ...
            'Sicilian Defense': [
                { pos: ['rnbqkbnr','pppppppp','........','........','........','........','PPPPPPPP','RNBQKBNR'], move: 'Starting Position' },
                { pos: ['rnbqkbnr','pppppppp','........','........','....P...','........','PPPP.PPP','RNBQKBNR'], move: '1. e4' },
                { pos: ['rnbqkbnr','pp.ppppp','........','..p.....','....P...','........','PPPP.PPP','RNBQKBNR'], move: '1... c5' },
                { pos: ['rnbqkbnr','pp.ppppp','........','..p.....','....P...','.....N..','PPPP.PPP','RNBQKB.R'], move: '2. Nf3' },
                { pos: ['rnbqkbnr','pp.ppp.p','......p.','..p.....','....P...','.....N..','PPPP.PPP','RNBQKB.R'], move: '2... g6' },
                { pos: ['rnbqkbnr','pp.ppp.p','......p.','..p.....','...PP...','.....N..','PPP..PPP','RNBQKB.R'], move: '3. d4' },
            ],
            'Queen\'s Gambit': [
                { pos: ['rnbqkbnr','pppppppp','........','........','........','........','PPPPPPPP','RNBQKBNR'], move: 'Starting Position' },
                { pos: ['rnbqkbnr','pppppppp','........','........','...P....','........','PPP.PPPP','RNBQKBNR'], move: '1. d4' },
                { pos: ['rnbqkbnr','ppp.pppp','........','...p....','...P....','........','PPP.PPPP','RNBQKBNR'], move: '1... d5' },
                { pos: ['rnbqkbnr','ppp.pppp','........','...p....','..PP....','........','PP..PPPP','RNBQKBNR'], move: '2. c4' },
                { pos: ['rnbqkbnr','ppp.pp.p','......p.','...p....','..PP....','........','PP..PPPP','RNBQKBNR'], move: '2... g6' },
                { pos: ['rnbqkbnr','ppp.pp.p','......p.','...p....','..PP....','.....N..','PP..PPPP','RNBQKB.R'], move: '3. Nf3' },
            ],
            'Italian Game': [
                { pos: ['rnbqkbnr','pppppppp','........','........','........','........','PPPPPPPP','RNBQKBNR'], move: 'Starting Position' },
                { pos: ['rnbqkbnr','pppppppp','........','........','....P...','........','PPPP.PPP','RNBQKBNR'], move: '1. e4' },
                ...
                { pos: ['rnbqkbnr','pppp.ppp','........','....p...','....P...','.....N..','PPPP.PPP','RNBQKB.R'], move: '2. Nf3' },
                { pos: ['r.bqkbnr','pppp.ppp','..n.....','....p...','....P...','.....N..','PPPP.PPP','RNBQKB.R'], move: '2... Nc6' },
                { pos: ['r.bqkbnr','pppp.ppp','..n.....','....p...','..B.P...','.....N..','PPPP.PPP','RNBQK..R'], move: '3. Bc4' },
            ],
            'French Defense': [
                { pos: ['rnbqkbnr','pppppppp','........','........','........','........','PPPPPPPP','RNBQKBNR'], move: 'Starting Position' },
                { pos: ['rnbqkbnr','pppppppp','........','........','....P...','........','PPPP.PPP','RNBQKBNR'], move: '1. e4' },
                { pos: ['rnbqkbnr','pppp.ppp','....p...','........','....P...','........','PPPP.PPP','RNBQKBNR'], move: '1... e6' },
                { pos: ['rnbqkbnr','pppp.ppp','....p...','........','...PP...','........','PPP..PPP','RNBQKBNR'], move: '2. d4' },
                { pos: ['rnbqkbnr','ppp..ppp','....p...','...p....','...PP...','........','PPP..PPP','RNBQKBNR'], move: '2... d5' },
                { pos: ['rnbqkbnr','ppp..ppp','....p...','...p....','...PP...','.....N..','PPP..PPP','RNBQKB.R'], move: '3. Nf3' },
            ],
            'King\'s Indian Defense': [
                { pos: ['rnbqkbnr','pppppppp','........','........','........','........','PPPPPPPP','RNBQKBNR'], move: 'Starting Position' },
                { pos: ['rnbqkbnr','pppppppp','........','........','...P....','........','PPP.PPPP','RNBQKBNR'], move: '1. d4' },
                { pos: ['rnbqkb.r','pppppppp','.....n..','........','...P....','........','PPP.PPPP','RNBQKBNR'], move: '1... Nf6' },
                { pos: ['rnbqkb.r','pppppppp','.....n..','........','..PP....','........','PP..PPPP','RNBQKBNR'], move: '2. c4' },
                { pos: ['rnbqkb.r','pppppp.p','.....n.p','........','..PP....','........','PP..PPPP','RNBQKBNR'], move: '2... g6' },
                { pos: ['rnbqkb.r','pppppp.p','.....n.p','........','..PP....','.....N..','PP..PPPP','RNBQKB.R'], move: '3. Nf3' },
            ]
        };
        
        let currentSequence = openingSequences['Ruy Lopez'];
        let currentOpeningName = 'Ruy Lopez';
        ...
        function renderBoard(position, targetElement) {
            ...
            // Reapply current board theme after rendering
            reapplyCurrentBoardTheme();
        }
        
        function reapplyCurrentBoardTheme() {
            try {
                ...
                if (user && !user.isAnonymous) {
                    ...
                    // Fallback to global theme for anonymous users
                    const globalTheme = localStorage.getItem('boardTheme');
                    if (globalTheme && boardThemes[globalTheme]) {
                        currentTheme = globalTheme;
                    }
                }
                
                // Apply the theme without saving (since we're just reapplying)
                const theme = boardThemes[currentTheme];
                if (theme && boardElement) {
                ...
                console.warn('Could not reapply board theme', e);
            }
        }
        
        function playOpeningAnimation(openingName) {
            const sequence = openingSequences[openingName];
            if (!sequence) return;
            
            clearInterval(animationInterval);
            let moveIndex = 0;
            animateBtn.disabled = true;
            animateBtn.textContent = `Playing ${openingName}...`;
            
            animationInterval = setInterval(() => {
                if (moveIndex >= sequence.length) {
                    clearInterval(animationInterval);
                    openingInfo.textContent = `That's the ${openingName}! Select another opening or click to replay.`;
                    animateBtn.disabled = false;
                    animateBtn.textContent = `Play ${openingName}`;
                    return;
                }
                const currentMove = sequence[moveIndex];
        ...
        // Add event listener for opening selector
        openingSelector?.addEventListener('change', (e) => {
            currentOpeningName = e.target.value;
            currentSequence = openingSequences[currentOpeningName];
            renderBoard(currentSequence[0].pos);
            animateBtn.textContent = `Play ${currentOpeningName}`;
            openingInfo.textContent = `Ready to play ${currentOpeningName}. Click the button to see the moves.`;
        });
        
        // initial render
        renderBoard(currentSequence[0].pos);
        animateBtn?.addEventListener('click', () => {
            playOpeningAnimation(currentOpeningName);
        });
        ...
        const handleSignup = async (e) => {
            ...
            try {
                ...
                else if (code === 'auth/operation-not-allowed') formMessageEl.textContent = 'Email/password sign-in is disabled in Firebase (enable it in Authentication → Sign-in method).';
                else if (code === 'auth/email-already-in-use') formMessageEl.textContent = 'This email is already registered.';
                else if (String(error?.message || '').includes('Auth not initialized')) formMessageEl.textContent = 'Firebase is not initialized — check the config at the top of index.html.';
        ...
        const handleSignin = async (e) => {
            ...
            try {
                ...
                else if (String(error?.message || '').includes('Auth not initialized')) formMessage.textContent = 'Firebase is not initialized — check the config at the top of index.html.';
        ...
        (function bootstrap() {
            ...
            if (missing.length) {
                ...
                setRibbon('Config OK. Initializing…', 'bg-emerald-700');
            }
        })();
        ...
        function openCustomizationModal() {
            ...
            `;
            modalTitle.textContent = '🎨 Customization';
        ...
        function openPerformanceStatsModal() {
            ...
            `;
            modalTitle.textContent = '📊 Performance Stats';
        ...
        getRecommendationBtn?.addEventListener('click', async () => {
            ...
            try {
                ...
                recommendationResult.innerHTML = `<p class="text-red-500">Sorry — the coach is unavailable right now. ${String(err?.message || '')}</p>`;
                recommendationResult.classList.remove('hidden');
            } finally {
        ...
        // --- “Test cases” for your page (quick validation in console) ---
        (function selfTests() {
            const cases = [];
            const f = CONFIG.FIREBASE || {};
            ...
            console.groupCollapsed('%cChessUnlocked — setup self-tests', 'color:#10b981;font-weight:bold');
            cases.forEach(c => console.log(`${c.pass ? '✅' : '❌'} ${c.name}`));
        ...
        function generateBoardStatesFromPgn(pgn) {
            ...
            // For now, we'll match against known openings and return their sequences
            if (pgn.includes('Bb5')) {
                return openingSequences['Ruy Lopez'].map(s => s.pos);
            } else if (pgn.includes('c5')) {
                return openingSequences['Sicilian Defense'].map(s => s.pos);
            } else if (pgn.includes('d4 d5 2. c4')) {
                return openingSequences['Queen\'s Gambit'].map(s => s.pos);
            } else if (pgn.includes('Bc4')) {
                return openingSequences['Italian Game'].map(s => s.pos);
            } else if (pgn.includes('e6')) {
                return openingSequences['French Defense'].map(s => s.pos);
            } else if (pgn.includes('Nf6 2. c4 g6')) {
                return openingSequences['King\'s Indian Defense'].map(s => s.pos);
            }
        ...
        const practiceDrills = [
            {
                ...
                board: ['r.bqkbnr','pppp.ppp','..n.....','.B..p...','....P...','.....N..','PPPP.PPP','RNBQK..R'], // Ruy Lopez after 3. Bb5
            ...
            {
                name: 'Name the Opening',
                board: ['rnbqkbnr','pppp.ppp','........','....p...','....P...','........','PPPP.PPP','RNBQKBNR'], // King's Pawn after 1. e4 e5
                question: 'Which opening is shown on the board?',
            ...
            {
                name: 'Name the Opening',
                board: ['rnbqkbnr','pp.ppppp','........','..p.....','....P...','........','PPPP.PPP','RNBQKBNR'], // Sicilian Defense after 1. e4 c5
                question: 'Which opening is shown on the board?',
            ...
            {
                name: 'Name the Opening',
                board: ['rnbqkbnr','pppp.ppp','........','....p...','....P...','........','PPPP.PPP','RNBQKBNR'], // French Defense after 1. e4 e6
                question: 'Which opening is shown on the board?',
            ...
            {
                name: 'Name the Opening',
                board: ['rnbqkbnr','ppp.pppp','........','...p....','..P.....','........','PP.PPPPP','RNBQKBNR'], // Queen's Gambit after 1. d4 d5 2. c4
                question: 'Which opening is shown on the board?',
            ...
            {
                name: 'Name the Opening',
                board: ['r.bqkbnr','pppp.ppp','..n..n..','....p...','..B.P...','........','PPPP.PPP','RNBQK.NR'], // Italian Game after 1. e4 e5 2. Nf3 Nc6 3. Bc4 Nf6
                question: 'Which opening is shown on the board?',
            ...
            {
                name: 'Name the Opening',
                board: ['rnbqkb.r','pppppp.p','......p.','........','..P.....','........','PP.PPPPP','RNBQKBNR'], // King's Indian Defense after 1. d4 Nf6 2. c4 g6
                question: 'Which opening is shown on the board?',
                options: ['Grünfeld Defense', 'King\'s Indian Defense', 'Nimzo-Indian Defense'],
